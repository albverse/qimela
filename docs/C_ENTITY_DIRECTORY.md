...
| `chimera_nun_snake` | enemies/chimera_nun_snake/ChimeraNunSnake.tscn | enemies/chimera_nun_snake/chimera_nun_snake.gd | LIGHT | MEDIUM | ❌未设置 | 修女蛇奇美拉（攻击型；闭眼/开眼双形态；眼球发射/石化/融合占位） |
