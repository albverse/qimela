...
| `boss_ghost_witch` | enemies/boss_ghost_witch/BossGhostWitch.tscn | enemies/boss_ghost_witch/boss_ghost_witch.gd | NORMAL | LARGE | ❌未设置 | 幽灵魔女Boss（三阶段/Beehave驱动/仅ghost_fist可造成真实伤害） |
